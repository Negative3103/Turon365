...
func (r *WorkerRepository) Create(worker *models.Worker) error {
	query := `INSERT INTO workers (id, name, phone_number, experience, is_approved, confirmed, created_at) 
              VALUES (:id, :name, :phone_number, :experience, :is_approved, :confirmed, :created_at)`
